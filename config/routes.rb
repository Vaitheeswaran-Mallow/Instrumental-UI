Rails.application.routes.draw do
  ...
  get ':account_slug/invitations/:id/accept', to: 'invitations#accept', as: :accept_invitation
  ...
  # Account Users
  get ':account_slug/members', to: 'account_users#index', as: :account_members
  get ':account_slug/members/:id', to: 'account_users#edit', as: :edit_account_member
  patch ':account_slug/members/:id', to: 'account_users#update', as: :update_account_member
  delete ':account_slug/members/:id', to: 'account_users#destroy', as: :destroy_account_member
  # Accounts
